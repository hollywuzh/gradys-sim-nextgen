"""Minimal RLlib PPO training smoke test for the uavsim4security bridge."""
...
from rllib_uavsim4security_adapter import UAVSim4SecurityRLlibEnv


SHOWCASE_DIR = Path(__file__).resolve().parent
ENV_NAME = "uavsim4security_rllib"
POLICY_ID = "shared_uav_routing_policy"
...
def main() -> None:
    ...
    register_env(ENV_NAME, lambda config: UAVSim4SecurityRLlibEnv(dict(config)))
    if args.action_mask:
        register_action_mask_model()

    reference_env = UAVSim4SecurityRLlibEnv(env_config)
    ...
    print(f"Wrote uavsim4security PPO metrics: {output_path.resolve()}")
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--rollout-fragment-length", type=int, default=8)
    ...
    parser.add_argument("--checkpoint-dir", default="outputs/uavsim4security_rllib_checkpoints")
    parser.add_argument("--output", default="outputs/uavsim4security_rllib_ppo_metrics.json")
