...
class Opar:
    ...
    def next_hop_selection(self, packet):
        ...
        if packet.src_drone == self.my_drone:  # if it is the source, optimization should be executed
            ...
            best_next_hop_id = self.best_path[0] if self.best_path else self.my_drone.identifier
