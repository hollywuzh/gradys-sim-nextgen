...
class QGeo:
    ...
    def update_q_table(self, packet, next_hop_id, next_hop_coords, next_hop_velocity):
        ...
        future_pos_myself = [coord + delta * t for coord, delta in zip(self.my_drone.coords, self.my_drone.velocity)]
        future_pos_next_hop = [coord + delta * t for coord, delta in zip(next_hop_coords, next_hop_velocity)]
